...
const createEvent = async (req, res) => {
  try {
    const { title, description, time, date, no_of_visitors } = req.body;
    ...
    if (!title || !description || !time || !date || !no_of_visitors ) {
...
const updateEvent = async (req, res) => {
  try {
    const { title, description, time, date, no_of_visitors ,oldImage,  Imagefilename } = req.body;
    const eventImage = req.file
